...
class EvalBatch(Base):
    ...
    eval_mode = Column(String(10), default="base")
    annotation_mode = Column(String(20), default="single")
    fail_code_mode = Column(String(20), default="optional")
    pe_checkpoint_mode = Column(String(20), default="required")
    pe_hide_source = Column(Integer, default=1)
...
class Video(Base):
    ...
    question_id = Column(Integer, ForeignKey("questions.id"))
    oss_url = Column(Text)
    pair_b_url = Column(Text)
    pe_prompt = Column(Text)
    display_order = Column(String(2))
...
class Assignment(Base):
    ...
    pe_comparison = Column(Text)
    pe_reason = Column(Text)
